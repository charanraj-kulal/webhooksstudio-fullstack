          ...
          >
            ...
            <div className="flex flex-col justify-center gap-4 w-full md:w-1/2">
              ...
              <p className="text-sm sm:text-base md:text-lg">
                ...
                providing top-notch services and solutions to our clients. With
                our expertise in web development, we strive to deliver
                innovative and high-quality products that meet the needs of our
                customers.
              </p>
              <p className="text-sm sm:text-base md:text-lg">
                Our mission is to empower businesses and individuals by
                leveraging the latest technologies and delivering exceptional
                results. We believe in building strong and long-lasting
